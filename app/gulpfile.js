...
gulp.task("vendor", function(){
    ...
    var langFilter = $.filter('**/*.lang',{restore: false});
 

    var vendorSrc = JSON.parse(fs.readFileSync("vendor.json","utf-8"));
...
gulp.task('sass', function () {
  ...
  gulp.task('watch', function () {
    gulp.watch('sass/**/*.scss', gulp.series('sass', 'themes') );
  });
  ...
  gulp.task('default', gulp.series('vendor','sass','themes','watch'));
